...
define(function(require, exports, module) {
    ...
    Size
    */
    Flipper.prototype.getSize = function getSize(){
    ...
    Flipper.prototype.render = function render() {
        ...
        if (this.options.direction === Flipper.DIRECTION_X) {
            frontTransform = Transform.moveThen([-this.options.size[0]/2,0,0],Transform.rotateY(angle));
            backTransform = Transform.moveThen([-this.options.size[0]/2,0,0],Transform.rotateY(angle + Math.PI));
        }
        else {
